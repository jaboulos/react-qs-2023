Below is a sample React interview question along with a brief problem statement. The question is designed to test your understanding of React components, state, and props:
